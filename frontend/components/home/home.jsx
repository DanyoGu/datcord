...
import ServerIndexItemContainer from "../server/server_index_item_container"
          ...
          <div className="homepage">
            <header>
                <div className="homepage-welcome-message">
                    ...
                    <img
                        src="https://fontmeme.com/permalink/201014/75354d64bc7789102a420ad0bdff9948.png"
                    ...
                    <br/>
                    <br/>
                    <span>Join or Create a Server to Start</span>
                </div>
            </header>
          </div>
        </div>
